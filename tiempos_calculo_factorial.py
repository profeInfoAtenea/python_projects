...
print("Han trascurrido ", time.time(), " segundos desde el 1 de enero de 1970")
'''
#
'''
inicio = time.time()
...
print("res_fact_while:",res_fact_while,", res_fact_for:",res_fact_for, "res_fact_rec:",res_fact_rec)import time
